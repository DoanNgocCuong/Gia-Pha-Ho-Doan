...
#### 7. Căn giữa Đời 1 và Đời 2 vào trung tâm sơ đồ
- Bổ sung **Phase 2e** trong thuật toán layout để tính toán và cập nhật lại tọa độ X cho các đời tổ tiên duy nhất (`d0` và `d1`) sau khi tất cả các dịch chuyển dòng hoàn tất.
- Giúp Cụ Tổ (Đời 1) và Cụ Rũng (Đời 2) luôn nằm chính giữa trung điểm các con ở đời sau, không bị lệch sang bên phải do Nhánh I dịch chuyển.
- **Tệp:** [`utils/tree-layout-v2.js`](utils/tree-layout-v2.js)
